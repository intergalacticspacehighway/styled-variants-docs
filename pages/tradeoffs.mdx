...
<br />
e.g. Something like this cannot be done.
...
- `sx` prop is resolved and converted to stylesheet or style object during build time. Thus the token values should be used inline.
